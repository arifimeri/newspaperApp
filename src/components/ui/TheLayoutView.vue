...
import bgImage from '@/assets/img/post-landscape-1.jpg';
import slideImage2 from '@/assets/img/post-slide-2.jpg';
import slideImage3 from '@/assets/img/post-slide-3.jpg';
import slideImage4 from '@/assets/img/post-slide-4.jpg';
import postImage1 from '@/assets/img/post-landscape-1.jpg';
import personImage1 from '@/assets/img/person-1.jpg';
import personImage2 from '@/assets/img/person-2.jpg';
import personImage4 from '@/assets/img/person-4.jpg';
import personImage7 from '@/assets/img/person-7.jpg';
import postImage2 from '@/assets/img/post-landscape-2.jpg';
import postImage3 from '@/assets/img/post-landscape-3.jpg';
import postImage4 from '@/assets/img/post-landscape-4.jpg';
import postImage5 from '@/assets/img/post-landscape-5.jpg';
import postImage6 from '@/assets/img/post-landscape-6.jpg';
import postImage7 from '@/assets/img/post-landscape-7.jpg';
import postImage8 from '@/assets/img/post-landscape-8.jpg';
            ...
            <div class="col-lg-4">
              ...
              <div class="post-entry lg">
                ...
                <div class="d-flex align-items-center author">
                  <div class="photo"><img :src="personImage1" alt="" class="img-fluid" /></div>
                  <div class="name">
              ...
              <div class="row g-5">
                <div class="col-lg-4 border-start custom-border">
                  <div class="post-entry">
                    <a href="blog-details.html"><img :src="postImage2" alt="" class="img-fluid" /></a>
                  ...
                  <div class="post-entry">
                    <a href="blog-details.html"><img :src="postImage7" alt="" class="img-fluid" /></a>
                ...
                <div class="col-lg-4 border-start custom-border">
                  ...
                  <div class="post-entry">
                    <a href="blog-details.html"><img :src="postImage6" alt="" class="img-fluid" /></a>
                  ...
                  <div class="post-entry">
                    <a href="blog-details.html"><img :src="postImage8" alt="" class="img-fluid" /></a>
          ...
          <div class="col-md-9">
            ...
            <div class="d-lg-flex post-entry">
              <a href="blog-details.html" class="me-4 thumbnail mb-4 mb-lg-0 d-inline-block">
                <img :src="postImage6" alt="" class="img-fluid" />
              </a>
              <div>
                <div class="post-meta"><span class="date">Culture</span> <span class="mx-1">•</span> <span>Jul 5th '22</span></div>
                ...
                <div class="d-flex align-items-center author">
                  <div class="photo"><img :src="personImage2" alt="" class="img-fluid" /></div>
                  <div class="name">
          ...
          <div class="col-md-9 order-md-2">
            ...
            <div class="d-lg-flex post-entry">
              <a href="blog-details.html" class="me-4 thumbnail d-inline-block mb-4 mb-lg-0">
                <img :src="postImage3" alt="" class="img-fluid" />
              </a>
              <div>
                <div class="post-meta"><span class="date">Business</span> <span class="mx-1">•</span> <span>Jul 5th '22</span></div>
                <h3><a href="blog-details.html">What is the son of Football Coach John Gruden, Deuce Gruden doing Now?</a></h3>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Distinctio placeat exercitationem magni voluptates dolore. Tenetur fugiat voluptates quas, nobis error deserunt aliquam temporibus sapiente, laudantium dolorum itaque libero eos deleniti?</p>
                <div class="d-flex align-items-center author">
                  <div class="photo"><img :src="personImage4" alt="" class="img-fluid" /></div>
                  <div class="name">
                    <h3 class="m-0 p-0">Wade Warren</h3>
                  </div>
                </div>
        ...
        <div class="row g-5">
          <div class="col-lg-4">
            <div class="post-list lg">
              ...
              <div class="d-flex align-items-center author">
                <div class="photo"><img :src="personImage7" alt="" class="img-fluid" /></div>
                <div class="name">
          ...
          <div class="col-lg-8">
            <div class="row g-5">
              <div class="col-lg-4 border-start custom-border">
                ...
                <div class="post-list">
                  <a href="blog-details.html">  <img :src="postImage4" alt="" class="img-fluid" /></a>
