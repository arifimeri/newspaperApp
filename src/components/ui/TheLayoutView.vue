      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="swiper init-swiper">
          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide" style="background-image: url('../../assets/img/post-landscape-1.jpg');">
              <div class="content">
          ...
          <div class="row g-5">
            <div class="col-lg-4">
              ...
              <div class="post-entry lg">
                <a href="blog-details.html"><img v-bind:src="NewsImage1"alt="" class="img-fluid"></a>
...
export default {
  ...
  data() {
    return {
      NewsImage1:("../../assets/img/post-landscape-1.jpg")
    }
  },
}
</script>
